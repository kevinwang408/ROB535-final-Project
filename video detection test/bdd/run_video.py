...
config_file = "D:/ROB 535 HW/detr_facebook/mmdetection/work_dirs/deformable_detr_bdd_ninja/bdd_ninja_config.py" 

# 2. 剛下載回來的權重檔路徑
checkpoint_file = "D:/ROB 535 HW/detr_facebook/mmdetection/work_dirs/deformable_detr_bdd_ninja/epoch_50.pth" # 請改成您的實際路徑

# 3. 要測試的影片檔 (請準備一個 mp4)
video_path = "D:/ROB 535 HW/detr_facebook/mmdetection/test_video/phili.mp4" 

# 4. 輸出結果檔名
out_path = "D:/ROB 535 HW/detr_facebook/mmdetection/video detection test/bdd/result_video.mp4"
